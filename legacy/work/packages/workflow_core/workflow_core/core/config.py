...
class Settings:
    ...
    rag_base_url: str = _env("RAG_BASE_URL", "http://127.0.0.1:8000")
    rag_api_key: str = _env("RAG_API_KEY", "change-me")
    trace_store_path: str = _env("WORKFLOW_INTERNAL_TRACE_PATH", "storage/traces/workflow_internal.jsonl")
    ticket_store_path: str = _env("TICKET_STORE_PATH", "storage/tickets/tickets.jsonl")
