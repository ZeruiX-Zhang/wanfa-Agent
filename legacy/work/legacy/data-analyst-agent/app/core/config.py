...
class Settings:
    ...
    database_url: str = field(default_factory=lambda: os.getenv("DATABASE_URL", "sqlite:///data/analyst.db"))
    trace_store_path: str = field(default_factory=lambda: os.getenv("TRACE_STORE_PATH", "data/traces/runs.jsonl"))
    chart_output_dir: str = field(default_factory=lambda: os.getenv("CHART_OUTPUT_DIR", "data/charts"))
